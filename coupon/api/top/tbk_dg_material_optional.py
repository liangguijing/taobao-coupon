# -*- coding: utf-8 -*-
"""
@Time: 3/11/2021 10:49
@Name: tbk_dg_material_optional.py
@Author: https://github.com/liangguijing
@Description: taobao.tbk.dg.material.optional( 淘宝客-推广者-物料搜索 )
...
class TbkDgMaterialOptional(RestApi):
    def __init__(self, domain='gw.api.taobao.com', port=80):
        ...
        self.material_id = None  # 官方的物料Id(详细物料id见：
        # https://tbk.bbs.taobao.com/detail.html?appId=45301&postId=8576096)，不传时默认为2836
        ...
        self.q = None  # 查询词
        self.sort = None  # 排序_des（降序），排序_asc（升序），销量（total_sales），
        # 淘客佣金比率（tk_rate）， 累计推广量（tk_total_sales），总支出佣金（tk_total_commi），价格（price）
